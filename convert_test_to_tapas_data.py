...
def main():
    ...
    parser.add_argument("--retrieved_tables_file", default=None, type=str, help="Path to the tapas train data")
    parser.add_argument("--output_data_file", default=None, type=str, help="Path to the output folder, where the top k documents should be stored")
    ...
    if ".jsonl" not in args.output_data_file:
        raise RuntimeError("The output file path should include the name of the .jsonl file")
